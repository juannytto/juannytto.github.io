...
function funCall() {
    ...
    setTimeout(() => {
        ...
        for (var i = 0; i < category.length; i++) {
            categorie += '<a id="category' + category[i].id + '" onclick="loadCategoryPage(' + category[i].id + ',' + 0 + ')" href="#"> ' + category[i].name + ' </a>';
        }
        ...
        //add id the products info <- to be loaded in product.html
        //check number of star
        function isThisNbStar(nb, pNb) {
            html = ''
            if (pNb >= nb) {
                html += 'checked'
            } return html;
        ...
        infoProduit += '          <span class="fa fa-star ' + isThisNbStar(1, productobject[produitKey].rate) + '"></span>';
        infoProduit += '          <span class="fa fa-star ' + isThisNbStar(2, productobject[produitKey].rate) + '"></span>';
        infoProduit += '          <span class="fa fa-star ' + isThisNbStar(3, productobject[produitKey].rate) + '"></span>';
        infoProduit += '          <span class="fa fa-star ' + isThisNbStar(4, productobject[produitKey].rate) + '"></span>';
        infoProduit += '          <span class="fa fa-star ' + isThisNbStar(5, productobject[produitKey].rate) + '"></span>';
